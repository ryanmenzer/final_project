...
ActiveRecord::Schema.define(:version => 20131019012822) do
  ...
  create_table "sponsorships_users", :id => false, :force => true do |t|
    t.integer  "sponsorship_id", :null => false
  ...
  add_index "sponsorships_users", ["sponsor_id"], :name => "index_sponsorships_users_on_sponsor_id"
  ...
  add_index "transactions", ["paypal_status"], :name => "index_transactions_on_paypal_status"
